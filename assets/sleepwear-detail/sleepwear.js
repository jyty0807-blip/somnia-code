...
(function(){
  ...
  var BG_KEYS=['fabric','craft','care','quality','spec','notice'];
  var HL_KEYS=['fabric','craft'];
  var IMG_KEYS=['hero','craft'];
  ...
  function textFields(key){
    switch(key){
      ...
      case 'fabric': return [{sel:"[data-ed='fabric-h2']",lab:'제목'},
        {sel:"[data-ed='fab1-nm']",lab:'소재1 이름'},{sel:"[data-ed='fab1-cp']",lab:'소재1 설명'},
        {sel:"[data-ed='fab2-nm']",lab:'소재2 이름'},{sel:"[data-ed='fab2-cp']",lab:'소재2 설명'},
        {sel:"[data-ed='fab3-nm']",lab:'소재3 이름'},{sel:"[data-ed='fab3-cp']",lab:'소재3 설명'}];
      case 'craft': return [{sel:"[data-ed='craft-eyebrow']",lab:'eyebrow'},{sel:"[data-ed='craft-h2']",lab:'헤드라인'},{sel:"[data-ed='craft-body']",lab:'본문'}];
      case 'care': return [{sel:"[data-ed='care-h2']",lab:'제목'},
        {sel:"[data-ed='wash-t']",lab:'세탁 제목'},{sel:"[data-ed='wash-1']",lab:'세탁 스텝1'},{sel:"[data-ed='wash-2']",lab:'세탁 스텝2'},{sel:"[data-ed='wash-3']",lab:'세탁 스텝3'},
        {sel:"[data-ed='store-t']",lab:'보관 제목'},{sel:"[data-ed='store-1']",lab:'보관 스텝1'},{sel:"[data-ed='store-2']",lab:'보관 스텝2'},{sel:"[data-ed='store-3']",lab:'보관 스텝3'}];
      case 'quality': return [{sel:"[data-ed='quality-h2']",lab:'제목'},
        {sel:"[data-ed='q1-k']",lab:'특징1'},{sel:"[data-ed='q1-d']",lab:'특징1 설명'},
        {sel:"[data-ed='q2-k']",lab:'특징2'},{sel:"[data-ed='q2-d']",lab:'특징2 설명'},
        {sel:"[data-ed='q3-k']",lab:'특징3'},{sel:"[data-ed='q3-d']",lab:'특징3 설명'},
        {sel:"[data-ed='q4-k']",lab:'특징4'},{sel:"[data-ed='q4-d']",lab:'특징4 설명'}];
      case 'spec': return [{sel:"[data-ed='spec-h2']",lab:'제목'},{sel:"[data-ed='topspec-h4']",lab:'상의 제품명'},{sel:"[data-ed='bottomspec-h4']",lab:'하의 제품명'}];
  ...
  async function exportPNG(s){
    try{
      ...
      download(url,'somnia-sleepwear-'+s.key+'.png');
      msg('완료 ✓');
  ...
  async function exportAll(){
    try{
      ...
      for(var i=0;i<SECS.length;i++){ var s=SECS[i]; if(s.frame.classList.contains('hidden-sec')) continue;
        var url=await captureNode(s.sec, 1000, s.sec.offsetHeight, 2);
        download(url,'somnia-sleepwear-'+String(i+1).padStart(2,'0')+'-'+s.key+'.png');
  ...
  async function exportStrip(){
    try{
      ...
      download(url,'somnia-sleepwear-full.png');
    }catch(e){ alert('내보내기 실패: '+(e.message||e)); console.error(e); }
  }
  ...
  async function exportHeroGIF(){
    try{
      ...
      gif.on('finished',function(b){ download(URL.createObjectURL(b),'somnia-sleepwear-hero-loop.gif'); msg('GIF 완료 ✓ ('+Math.round(b.size/1024)+'KB)'); });
      gif.render();
