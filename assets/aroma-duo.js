/* SOMNIA — Aroma Duo PDP interactions */
(function(){
  'use strict';
  var fmt=function(n){ return n.toLocaleString('ko-KR'); };
  var state={ comp:'듀오 세트', price:39000, qty:1 };
  ...
  /* ---------- composition select ---------- */
  var galleryMain=document.querySelector('.gallery__main');
  document.querySelectorAll('#comp-select .flavor').forEach(function(btn){
    btn.addEventListener('click',function(){
      ...
      if(galleryMain && btn.dataset.comp) galleryMain.dataset.comp=btn.dataset.comp;
