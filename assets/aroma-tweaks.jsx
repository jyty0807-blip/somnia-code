/* SOMNIA Aroma Duo — Tweaks (font scale + accent + image radius + sticky bar) */
  ...
  return (
    <TweaksPanel>
      ...
      <TweakColor label="강조색" value={t.accent}
                  options={['#6f5b9e','#7d9bc4','#195B82','#8b78b8']}
...
(function mount(){
  ...
  if(root && window.ReactDOM && window.useTweaks){
    ReactDOM.createRoot(root).render(<AromaTweaks/>);
